class User < ApplicationRecord
  ...
  has_many :notifications, -> { includes([{ event: { record: [:story, :rich_text_reason, :reporter, :author] } }]).order(created_at: :desc) }, as: :recipient, dependent: :destroy, class_name: 'Noticed::Notification'
